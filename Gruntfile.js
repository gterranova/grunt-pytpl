...
module.exports = function(grunt) {
  ...
  grunt.file.mkdir('test/expected/pytpl_test_mix/empty_folder');
  ...
  grunt.initConfig({
    ...
    pytpl: {
      main: {
        files: [
          {expand: true, cwd: 'test/fixtures', src: ['*.*'], dest: 'tmp/pytpl_test_files/'},
          {expand: true, cwd: 'test/fixtures', src: ['**'], dest: 'tmp/pytpl_test_mix/'},
      ...
      verbose: {
        files: [
          {expand: true, src: ['test/fixtures/**'], dest: 'tmp/pytpl_test_verbose/'}
        ]
      }
    },
  ...
  grunt.registerTask('test', ['clean', 'pytpl', 'nodeunit']);
